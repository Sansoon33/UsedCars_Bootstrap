...
<div class="container mt-5">
  ...
  <form id="carForm" class="text-center" action="" method="post">
    <div class="form-group">
      <h4>Select User</h4>
      <select id="buttonMarginsSelect" class="btn btn-secondary" name="selectedUser">
        <?php
      ...
      while ($carInfo = mysqli_fetch_assoc($finalResult2)) {
        if (isset($_POST['make']) || isset($_POST['model']) || isset($_POST['year']) || isset($_POST['color']) || isset($_POST['car_condition']) || isset($_POST['asking_price']) || isset($_POST['date_posted'])) {
          ...
          <table class="table table-striped table-hover listings">
            ...
            <tbody>
              <tr>
                <td align="center"><?php echo $car_number ?></td>
    ...
    <div class="form-group">
      <input class="btn btn-success" type="submit" name="submit" value="View Info">
    </div>
  </form>
</div>
